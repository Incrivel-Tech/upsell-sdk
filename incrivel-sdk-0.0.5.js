/**
 * ============================================================================
 * INCRIVELTECH UPSELL SDK v5.0.0
 * ============================================================================
 *
 ...
 * Uso:
 * <script
 *   src="https://cdn.vendamais.top/sdks/incriveltech-sdk-0-0-5.js"
...
(function(w, d) {
    ...
    class VendaMaisSDK {
        constructor(config) {
            ...
            Logger.log('🚀 Iniciando IncrivelTech Upsell SDK v5.0.0');
        ...
        async flushEvents() {
            ...
            this.state.eventsQueue = []; // Clear queue optimistically
            ...
            if(!res) {
                 // Retry na proxima vez se falhou
